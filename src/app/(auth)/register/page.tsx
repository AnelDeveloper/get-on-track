...
export default function RegisterPage() {
  ...
  return (
    <div className="flex-1 flex flex-col lg:flex-row min-h-screen">
      {/* Hero Image */}
      <div className="relative h-[30vh] min-h-[200px] lg:h-auto lg:w-1/2 lg:min-h-screen">
        <Image
          src="/images/trainer/1-2.jpeg"
          alt="Fitness"
          fill
        ...
        <div className="absolute bottom-6 left-6 lg:bottom-auto lg:top-1/2 lg:-translate-y-1/2 lg:left-12 lg:max-w-md">
          ...
          <p className="text-zinc-300 text-sm lg:text-lg lg:mt-2 drop-shadow-md">Start your fitness journey</p>
          <p className="hidden lg:block text-zinc-300 text-sm mt-4 leading-relaxed drop-shadow-md">
            Create your free account and start sharing your fitness journey with a supportive community.
          </p>
        </div>
      </div>
      ...
      <div className="flex-1 flex flex-col justify-center px-6 py-8 lg:px-16 lg:py-12">
        <div className="w-full max-w-sm mx-auto">
          <h2 className="text-xl lg:text-2xl font-bold mb-6">Create your account</h2>
          ...
          <p className="text-center text-sm text-zinc-500 mt-6">
            ...
            <Link href="/login" className="text-lime-400 font-medium hover:underline">
              Sign In
            </Link>
          </p>
        </div>
